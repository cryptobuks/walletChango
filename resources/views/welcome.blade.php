...
<main id="main">
    ...
    <section id="services" class="section-bg">
        <div class="container">
            ...
            <header class="section-header">
                <h3>Services</h3>
                <p>Outr major service is to help a group of people or organization to come together and enable the
                    pulling of resources to attain a certain goal.</p>
            </header>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5 offset-lg-1 wow bounceInUp" data-wow-duration="1.4s">
                    <div class="box">
                        ...
                        <h4 class="title"><a href="">Chamaa</a></h4>
                        <p class="description">
                           We help people get organized into groups and help them contribute towards a certain goal.
                            We provide analysis of each group or person<br/>
                            <a class="btn btn-success" href="">Get Sarted</a>
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-5 wow bounceInUp" data-wow-duration="1.4s">
                    <div class="box">
                        ...
                        <h4 class="title"><a href="">Corporate Formations</a></h4>
                        <p class="description">
                            This provides something like captial intesive projects bidding
                        </p>
                    </div>
                </div>
